# core_services.py (FINAL FIX for NameError and Deadlock)
...
# FIX: Missing names ko yahaan seedha import karein
from aiogram import Bot, Dispatcher # Dispatcher NameError ko theek karega
...
class PriorityDispatcher:
    ...
    async def _worker_loop(self, worker_id: int):
        """Queue se updates nikalta hai aur process karta hai। (FIXED for Deadlock)"""
        while self.is_running:
            try:
                ...
                # NAYA FIX: Non-blocking check for available data in queues
