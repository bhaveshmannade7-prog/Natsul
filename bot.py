...
def python_fuzzy_search(query: str, limit: int = 10) -> List[Dict]:
    ...
    try:
        ...
        # Hum cache ki keys (jo clean_titles hain) par search karenge.
        ...
        results = process.extract(
            query,
            choices, # <-- Ab yeh ek List[str] hai
            scorer=fuzz.token_set_ratio, 
            limit=limit,
            score_cutoff=70 # Cutoff ko 70 kar diya hai taaki 'Aveger' (75) aur 'Katra' (71) jaise typos pakde ja sakein
        )
        # --- END NAYA LOGIC ---
