    ...
    def decorator(func: Callable):
        ...
        async def wrapper(*args, **kwargs):
            try:
                ...
                if target_chat_id:
                    try: 
                        # Yahaan hum bot instance ko kwargs se nikal rahe hain, jo DP se pass ہوگا
...
def get_full_limit_keyboard() -> InlineKeyboardMarkup | None:
    ...
    # BUG FIX: URL mein https://t.me/ use karein
...
async def start_command(message: types.Message, bot: Bot, db_primary: Database, db_fallback: Database, db_neon: NeonDB, redis_cache: RedisCacheLayer):
    ...
    # --- BUG FIX 1: /stats command call hataya gaya ---
    # /start call karte hi admin ko stats dikhane ke liye /stats command ko call karein
    # if user_id == ADMIN_USER_ID:
    #     await stats_command(message, bot, db_primary, db_fallback, db_neon, redis_cache)
    #     return
    # --- END BUG FIX 1 ---
