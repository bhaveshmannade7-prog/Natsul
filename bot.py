...
async def stats_command(message: types.Message):
    # ... (Same logic as start_command for admin) ...
    # Calling start_command internal logic via a wrapper or just duplicating for now
...
# --- Other Admin Commands (Unchanged Logic, just placeholders for context) ---
