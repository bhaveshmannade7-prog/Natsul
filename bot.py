...
try:
    ...
    # FIX APPLIED HERE: If ALTERNATE_BOT_TOKENS_RAW is defined, use it.
...
async def import_json_command(message: types.Message, db_primary: Database, db_fallback: Database, db_neon: NeonDB):
    ...
    await load_fuzzy_cache(db_primary)
    await safe_tg_call(bot_instance.send_message(message.chat.id, "✅ Fuzzy cache import ke baad reload ho gaya hai."))
