...
def python_fuzzy_search(query: str, limit: int = 12) -> List[Dict]: # FIX: limit 12 kiya gaya
    ...
    FIX: Cutoff lowered to 55 and limit set to 12 for better accuracy with typos.
    """
    ...
    try:
        ...
        results = process.extract(
            query,
            choices, 
            scorer=fuzz.WRatio, # WRatio best hai typo + partial match ke liye
            limit=limit,
            score_cutoff=55 # <-- MAIN FIX: 75/60 se 55 kiya gaya for more typo tolerance
        )
