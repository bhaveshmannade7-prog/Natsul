...
async def stats_command(message: types.Message, db_primary: Database, db_fallback: Database, db_neon: NeonDB):
    ...
    # --- Updated Output Message (FIXED: Shows Worker Count) ---
    stats_msg = (
        ...
        f"  - 🤖 Worker Bots: {len(bot_pool.workers)} Active\n"
        f"  - <b>{search_status}</b>"
    )
...
# =======================================================
# +++++ MAIN EXECUTION BLOCK (Updated for Render) +++++
# =======================================================

# This block ensures Uvicorn runs even if you execute 'python bot.py'
