...
def python_fuzzy_search(query: str, limit: int = 10) -> List[Dict]:
    ...
    try:
        ...
        # Hum `fuzz.WRatio` se `fuzz.token_set_ratio` par switch kar rahe hain
        # Yeh "kantara 2022" mein "katra" ko dhoondh lega
        # Hum score_cutoff ko 80 par set kar rahe hain
        
        results = process.extract(
            query,
            fuzzy_movie_cache,
            processor=lambda movie: movie['clean_title'], # <-- YEH HAI CRASH FIX
