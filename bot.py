...
# =======================================================
# +++++ ALGOLIA SEARCH HANDLER (FINAL FIX) +++++
# =======================================================
...
async def search_movie_handler(message: types.Message):
    ...
    # --- ⚠️ FINAL FIX ⚠️ ---
    # User ki query ko search karne se pehle clean karein
    # Taaki "Ktra." -> "ktra" ban jaaye aur "kantara" se match ho
    cleaned_query = clean_text_for_search(original_query)
    # Agar clean karne ke baad query < 2 ho (e.g., user ne sirf '.')
    ...
    # User ko original query dikhayein
    ...
    # Algolia ko 'cleaned' query bhejein
    search_results = await algolia_search(cleaned_query, limit=20) # Use the wrapper
