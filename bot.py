...
# --- FIX: IMPROVED CLEANING LOGIC (Updated) ---
...
def python_fuzzy_search(query: str, limit: int = 10) -> List[Dict]:
    ...
    try:
        ...
        # --- MAIN FIX ---
        # Scorer: 'token_set_ratio' best hai kyunki ye filenames (e.g. "Avatar 2009 1080p")
        # mein se main word "Avatar" ko dhund leta hai, bhale hi baaki text match na kare.
        # Cutoff: 72 set kiya hai taaki 'Agent' jaise bekar matches na aayein.
        ...
        results = process.extract(
            ...
            limit=limit,
            score_cutoff=72 # Raised to 72 to filter bad matches
        )
