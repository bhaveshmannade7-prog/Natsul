...
class Database:
    ...
    async def _connect(self):
        ...
        # --- FIX: Reverted to the stable check. This fixes the AttributeError and RuntimeWarning ---
    ...
    async def init_db(self):
        ...
        try:
            ...
            # --- FIX: Removed conflicting index creation. Aapka purana index 'file_id_1' aab istemal hoga. ---
            ...
            # Yeh error ab log hoga lekin bot crash nahi hoga
    ...
    async def mongo_search_internal(self, query: str, limit: int = 20) -> List[Dict]:
        ...
        if not await self.is_ready():
            logger.error("mongo_search_internal: DB not ready.")
            return []
        try:
