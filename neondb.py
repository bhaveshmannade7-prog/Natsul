...
class NeonDB:
    ...
    def __init__(self, database_url: str):
        ...
        self._init_lock = asyncio.Lock() # NAYA: Concurrency Lock
        self._initialized = False # NAYA: Initialization Flag
    ...
    async def init_db(self):
        ...
        if self._initialized:
             logger.debug("NeonDB already initialized by another worker.")
             return
             
        # Lock acquired only by the first worker
